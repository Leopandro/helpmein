...
return [
    ...
    */
    ...
    'array_checked'        => 'Как минимум :count из ответов должен быть выбран',
    'array_checked_radio'  => 'Должен быть выбран только 1 элемент',
    ...
    'captcha'              => 'Не удалось проверить на правильность введенной капчи',
