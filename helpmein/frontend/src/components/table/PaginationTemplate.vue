<template>
    <div class="card h-100">
        <div class="p-3">
            <div class="row">
                <div class="col-7 col-md-6 d-flex align-items-center justify-content-md-start">
                    {{$t('Страницы:')}}
                ...
                <div class="col-xl-auto col-lg-12 col-md-auto col-sm-12 ms-lg-auto d-flex align-items-center">
                    <div class="col-auto">{{$t('Задач на странице по:')}}</div>
